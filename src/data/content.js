...
export const marketingFeatures = [
  { span: 2, title: "Don't let another lead slip through the cracks",
    rive: '/assets/rive/leads.riv',
    riveLabel: 'Lead table showing guardians with Contacted, Tour Complete and Enrolled stages',
  ...
  { span: 2, title: 'Less paper, less work',
    rive: '/assets/rive/enrollment-form.riv',
    riveLabel: 'Digital enrollment form with a care schedule and signature field',
...
export const financeFeatures = [
  { span: 2, title: 'Payment collection on autopilot',
    rive: '/assets/rive/payments.riv',
    riveLabel: 'Payment list stepping through families with Paid, Due soon and Overdue states',
  ...
  { span: 1, story: true, title: 'I cut 4 systems down into just 1',
    rive: '/assets/rive/story-rail.riv',
    riveLabel: 'Row of app icons consolidating into Playground',
  ...
  { span: 1, title: 'Automatic expense tracking',
    rive: '/assets/rive/expenses.riv',
    riveLabel: 'Expense budget view',
